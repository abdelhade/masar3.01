...
<body>
    ...
    <div class="dialect">
        "يبدو أنك وصلت لمكان غير مخصص لك، يُفضّل الرجوع أو مراجعة الإدارة 😊"
    </div>

    <div class="buttons">
        <a href="{{ url('/dashboard') }}" class="button">العودة إلى الرئيسية</a>
        <a href="{{ url()->previous() }}" class="button">الرجوع إلى الصفحة السابقة</a>
    </div>
