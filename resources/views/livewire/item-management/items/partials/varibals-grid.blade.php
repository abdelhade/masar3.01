    ...
    <div class="col-md-12 mb-3">
        <div class="card">
            <div class="card-header bg-light">
                <h6 class="font-hold fw-bold mb-0">اختيار متغيرات الصنف</h6>
            </div>
            <div class="card-body">
                @if($varibals->count() > 0)
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label font-hold fw-bold">اختر المتغير للصفوف (العمود الرأسي):</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label font-hold fw-bold">اختر المتغير للأعمدة (الصف الأفقي):</label>
                    ...
                    <div class="mt-3">
                        <h6 class="font-hold fw-bold">إضافة توليفة جديدة:</h6>
                        <div class="row">
                            <div class="col-md-8">
                    ...
                    @if(count($selectedVaribalCombinations) > 0)
                        <div class="mt-3">
                            <h6 class="font-hold fw-bold">التوليفات المختارة:</h6>
                            <div class="row">
                                        ...
                                        <div class="card card-body p-2 bg-light combination-card">
                                            @if($editingCombinationKey === $combination['key'])
                                                <div class="d-flex flex-column gap-2">
                                                    <input type="text" wire:model="editingCombinationText" class="form-control form-control-sm font-hold fw-bold" placeholder="أدخل التوليفة المحدثة">
