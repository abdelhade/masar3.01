...
=======
    ...
    @endcanany
>>>>>>> a16d78fd196407997c19580201a465fbe9b78791
                ...
                <li class="li-main">
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        @canany(['عرض المعدلات', 'عرض تقييم الموظفين'])
                            <li class="nav-item has-submenu">
                                <a class="nav-link" href="javascript: void(0);">
                                    <i class="ti-control-record"></i>{{ 'معدلات الأداء' }}
                                    <span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
                                </a>
                                <ul class="sub-menu mm-collapse">
                                    @can('عرض المعدلات')
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('kpis.index') }}">
                                                <i class="ti-control-record"></i>{{ 'المعدلات' }}
                                            </a>
                                        </li>
                                    @endcan
                                    @can('عرض معدلات اداء الموظفين')
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('kpis.employeeEvaluation') }}">
                                                <i class="ti-control-record"></i>{{ 'معدلات أداء الموظفين' }}
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
                        ...
                        @canany(['عرض انواع العقود', 'عرض العقود'])
                            <li class="nav-item has-submenu">
                                <a class="nav-link" href="javascript: void(0);">
                                    <i class="ti-control-record"></i>{{ 'العقود' }}
                                    <span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
                                </a>
                                <ul class="sub-menu mm-collapse">
                                    @can('عرض انواع العقود')
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('contract-types.index') }}">
                                                <i class="ti-control-record"></i>{{ 'أنواع العقود' }}
                                            </a>
                                        </li>
                                    @endcan
                                    @can('عرض العقود')
                        ...
                        @canany(['عرض البصمات', 'عرض معالجه الحضور والانصراف'])
                            <li class="nav-item has-submenu">
                                <a class="nav-link" href="javascript: void(0);">
                                    <i class="ti-control-record"></i>{{ 'الحضور والانصراف' }}
                                    <span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
                                </a>
                                <ul class="sub-menu mm-collapse">
                                    @can('عرض البصمات')
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('attendances.index') }}">
                                                <i class="ti-control-record"></i>{{ 'البصمات' }}
                                            </a>
                                        </li>
                                    @endcan
