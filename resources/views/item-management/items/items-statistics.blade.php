...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="font-hold fw-bold">
                <i class="las la-chart-bar"></i> إحصائيات الأصناف
            </h3>
            <div>
                <a href="{{ route('items.index') }}" class="btn btn-secondary font-hold fw-bold">
                    <i class="las la-arrow-right"></i> رجوع
                </a>
                <a href="{{ route('items.statistics.refresh') }}" class="btn btn-primary font-hold fw-bold">
                ...
                <div class="card shadow-sm h-100 border-start border-primary border-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted font-hold fw-bold mb-2">إجمالي الأصناف</h6>
                                <h2 class="font-hold fw-bold mb-0 text-primary">{{ number_format($totalItems) }}
                                </h2>
                            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="card shadow-sm h-100 border-start border-success border-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted font-hold fw-bold mb-2">إجمالي الوحدات</h6>
                                <h2 class="font-hold fw-bold mb-0 text-success">{{ number_format($totalUnits) }}
                                </h2>
                            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="card shadow-sm h-100 border-start border-info border-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted font-hold fw-bold mb-2">إجمالي الباركود</h6>
                                <h2 class="font-hold fw-bold mb-0 text-info">{{ number_format($totalBarcodes) }}
                                </h2>
                            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="card shadow-sm h-100 border-start border-danger border-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted font-hold fw-bold mb-2">إحصائيات المتغيرات</h6>
                                <h2 class="font-hold fw-bold mb-0 text-danger"> {{ number_format($totalVaribals) }}
                                </h2>
                            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h6 class="text-muted font-hold fw-bold mb-2">متوسط الوحدات/صنف</h6>
                        <h3 class="font-hold fw-bold text-primary mb-0">{{ $avgUnitsPerItem }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h6 class="text-muted font-hold fw-bold mb-2">متوسط الباركود/صنف</h6>
                        <h3 class="font-hold fw-bold text-success mb-0">{{ $avgBarcodesPerItem }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h6 class="text-muted font-hold fw-bold mb-2">إجمالي الملاحظات</h6>
                        <h3 class="font-hold fw-bold text-info mb-0">{{ number_format($totalNotes) }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h6 class="text-muted font-hold fw-bold mb-2">إجمالي المتغيرات</h6>
                        <h3 class="font-hold fw-bold text-warning mb-0">{{ number_format($totalVaribals) }}</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        @forelse($itemsByType as $type => $count)
                            <div class="mb-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span
                                        class="badge bg-primary font-hold fw-bold">{{ number_format($count) }}</span>
                                </div>
                        ...
                        @empty
                            <div class="text-center py-4">
                                ...
                                <p class="text-muted font-hold fw-bold">لا توجد بيانات</p>
                            </div>
                        @endforelse
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        @forelse($priceRanges as $range => $count)
                            <div class="d-flex justify-content-between align-items-center mb-3 p-2 border-bottom">
                                ...
                                <span class="badge bg-info font-hold fw-bold">
                                    {{ number_format($count) }}
                                </span>
                            </div>
                        @empty
                            ...
                            <table class="table table-hover">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="font-hold fw-bold">اسم الصنف</th>
                                        <th class="font-hold fw-bold text-center">عدد الوحدات</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <table class="table table-hover">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="font-hold fw-bold">النوع</th>
                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                <div class="col-md-4 mb-3">
                                    <div class="p-3">
                                        <h6 class="text-muted font-hold fw-bold mb-2">أقل تكلفة</h6>
                                        <h3 class="font-hold fw-bold text-success">
                                            {{ number_format($costStats->min_cost, 2) }}</h3>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="p-3">
                                        <h6 class="text-muted font-hold fw-bold mb-2">متوسط التكلفة</h6>
                                        <h3 class="font-hold fw-bold text-primary">
                                            {{ number_format($costStats->avg_cost, 2) }}</h3>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="p-3">
                                        <h6 class="text-muted font-hold fw-bold mb-2">أعلى تكلفة</h6>
                                        <h3 class="font-hold fw-bold text-danger">
