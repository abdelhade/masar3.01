...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        $groupedPermissions = [
            ...
            'الموارد البشريه' => ['الادارات والاقسام', 'الوظائف', 'الدول', 'المحافظات', 'المدن', 'المناطق', 'الورديات', 'الموظفيين', 'المعدلات', 'معدلات اداء الموظفين', 'انواع العقود', 'العقود', 'البصمات', 'معالجه الحضور والانصرف'],
