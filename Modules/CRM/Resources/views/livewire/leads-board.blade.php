<div>
    ...
    <div class="container-fluid" style="max-width: 1600px; overflow-y: auto;">
                                ...
                                <tbody>
                                    @foreach ($reportData['leads_details'] as $lead)
                                        <tr>
                                            ...
                                            <td>{{ $lead['amount'] ? number_format($lead['amount']) . ' ' . __('EGP') : '-' }}
                                            </td>
                                            <td>{{ $lead['source'] }}</td>
        ...
        <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function updateScrollBasedOnTouchPosition(touch) {
                        ...
                        if (touchX <script script script leftZone) {
