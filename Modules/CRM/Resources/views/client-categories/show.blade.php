        ...
        <div class="col-12">
            <div class="page-title-box no-print">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="page-title">{{ __('Client Category Details') }}: {{ $category->name ?? '#' . $category->id }}</h4>
                    <div class="d-flex gap-2">
                        <a href="{{ route('client.categories.edit', $category) }}" class="btn btn-primary">
                            <i class="fas fa-edit"></i> {{ __('Edit') }}
                        </a>
                        <button onclick="window.print()" class="btn btn-info">
                            <i class="fas fa-print"></i> {{ __('Print') }}
                        </button>
                        <a href="{{ route('client.categories.index') }}" class="btn btn-secondary">
        ...
        <div class="col-12">
            <div class="card printable-content">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-folder"></i> {{ __('Client Category Information') }}</h5>
                </div>
                <div class="card-body">
                    <div class="row">
