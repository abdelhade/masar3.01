...
<div class="container-fluid">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-warning text-white">
                    <h4 class="mb-0">
                        ...
                        {{ __('general.edit_project') }}: {{ $project->name }}
                    </h4>
                </div>
            </div>
        </div>
    ...
    <form action="{{ route('progress.projects.update', $project) }}" 
          method="POST" 
          id="projectForm" 
          novalidate>
        @csrf
...
<style>
    ...
    .category-items-table th:nth-child(7) { width: 120px !important; min-width: 100px; max-width: 120px; }  
    ...
    .category-items-table th:nth-child(9) { width: 100px !important; min-width: 80px; max-width: 100px; }  
    
    .category-items-table td:nth-child(10),
    .category-items-table th:nth-child(10) { width: 150px !important; min-width: 120px; max-width: 150px; } 
    ...
    .category-items-table th:nth-child(12) { width: 100px !important; min-width: 80px; max-width: 100px; } 
    
    .category-items-table td:nth-child(13),
    .category-items-table th:nth-child(13) { width: 140px !important; min-width: 120px; max-width: 140px; } 
    ...
    .category-items-table th:nth-child(15) { width: 100px !important; min-width: 90px; max-width: 100px; } 
