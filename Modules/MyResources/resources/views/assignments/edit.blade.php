    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">تعديل التعيين</h4>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="assignment_type" id="assignment_type" class="form-select @error('assignment_type') is-invalid @enderror" required>
                                    ...
                                    @endphp
                                    <option value="current" {{ $currentType == 'current' ? 'selected' : '' }}>حالي</option>
                                    <option value="upcoming" {{ $currentType == 'upcoming' ? 'selected' : '' }}>قادم</option>
                                    <option value="past" {{ $currentType == 'past' ? 'selected' : '' }}>سابق</option>
                                </select>
