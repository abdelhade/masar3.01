    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">الحالات</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="header-title">قائمة الحالات</h4>
                        <div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <form action="{{ route('myresources.statuses.destroy', $status) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من الحذف؟');">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center">لا توجد حالات</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
