        ...
        <div class="col-12">
            <div class="page-title-box no-print">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="page-title">عرض الحالة: {{ $status->name_ar ?? $status->name }}</h4>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-control-static">{{ $status->name_ar ?? 'غير محدد' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <div class="form-control-static">{{ $status->description ?? 'لا يوجد وصف' }}</div>
                        </div>
                    </div>
